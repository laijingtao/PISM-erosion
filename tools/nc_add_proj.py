...
# Modified by Jingtao Lai, Geology@UIUC, Apr. 2017
...
parser.description = '''Script adds lat/lon to the netCDF file. Either a global attribute "projection", \
                     a mapping variable, or a command-line proj4 string or a EPSG code must be given.'''
